    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <asp:DetailsView ID="DetailsView1" runat="server"
                    DataKeyNames="ID" AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" AutoGenerateRows="false" Height="60px" Width="500px" 
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Product ID(s)">
                            <ItemTemplate>
