...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="offset-1 col-sm-5 table-responsive">
            ...
            </div><%--OnItemDeleting="DetailsView1_ItemDeleting" OnModeChanging="DetailsView1_ModeChanging" --%>
        <div class="col-sm-5">
            <asp:DetailsView ID="DetailsView1" runat="server"
                    DataKeyNames="ID" AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" AutoGenerateRows="false" Height="60px" Width="400px" 
                    BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" RowStyle-Width="200px">
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Amount">
                            <ItemTemplate>
                                <asp:Label ID="lblAmount" runat="server" Text='<%# Bind("AMMT") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtAmount" TextMode="Number" runat="server" Text='<%# Bind("AMMT") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Amount">
                            <ItemTemplate>
                                <asp:Label ID="lblShippingInfo" runat="server" Text='<%# Bind("AMMT") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtShippingInfo" runat="server" Text='<%# Bind("AMMT") %>' TextMode="Number"></asp:TextBox>                 
                            </EditItemTemplate>
                        </asp:TemplateField>
