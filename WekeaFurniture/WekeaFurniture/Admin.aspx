                ...
                <asp:DetailsView ID="DetailsView1" runat="server" OnItemDeleting="DetailsView1_ItemDeleting" OnItemInserted="DetailsView1_ItemInserted"
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText= "NAME">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtName1" runat="server" Text='<%# Bind("NAME") %>' CssClass="form-control" MaxLength="50"></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtName2" runat="server" CssClass="form-control" Text="Temporary" MaxLength="50" AutoPostBack="False"></asp:TextBox>
                            </InsertItemTemplate>
                        </asp:TemplateField>
